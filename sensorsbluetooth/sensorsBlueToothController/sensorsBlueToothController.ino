...
void loop() {
  ...
  if (xboxController.isConnected()) {
    float value[9] = {
      ...
      convert(xboxController.xboxNotif.btnA),
      convert(xboxController.xboxNotif.btnB),
      convert(xboxController.xboxNotif.btnX),
      convert(xboxController.xboxNotif.btnY),
      convert(xboxController.battery)
    };
